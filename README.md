...
Текущая версия разработки: **v0.0.9**.
...
- переработанные глубокие настройки LeaperKim: понятные названия, предупреждения и разделение потенциально опасных сервисных параметров;
...
Параметры глубокого разряда, калибровки напряжения и лимита зарядного напряжения выделяются отдельно как потенциально опасные или сервисные. Неясные настройки не выводятся в обычный интерфейс до подтверждения их реального физического смысла.
